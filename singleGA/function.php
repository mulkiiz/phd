...
{
	// echo "FASE: setMaxFit\n";
	$query = "select * from tb_fitness where fxberat <=1200 and iterasi=".$ith." ORDER BY fxberat DESC limit 1";
	$result = mysql_query($query) or die (mysql_error());

	$numrows = mysql_num_rows($result);
	if($numrows == 0){
		$query = "select * from tb_fitness where iterasi=".$ith." ORDER BY fxberat DESC, inknap DESC limit 1";
	}else{
		$query = "select * from tb_fitness where fxberat <=1200 and iterasi=".$ith." ORDER BY fxberat DESC limit 1";
	}
	$result = mysql_query($query) or die (mysql_error());
